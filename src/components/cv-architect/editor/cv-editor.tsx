...
import { User, Briefcase, GraduationCap, Sparkles as BrainCircuit, FileText, Heart, Award } from "lucide-react";
    ...
    <FormProvider {...form}>
      <form onSubmit={(e) => e.preventDefault()} className="h-full overflow-y-auto">
        <div className="p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          <Accordion type="multiple" defaultValue={["personal", "summary", "experience", "education", "training", "skills", "interests"]} className="w-full">
